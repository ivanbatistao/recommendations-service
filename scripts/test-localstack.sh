...
# Test script for LocalStack integration
...
aws dynamodb describe-table --table-name Recommendations --endpoint-url $LOCALSTACK_ENDPOINT --region $AWS_REGION
...
aws kinesis describe-stream --stream-name recommendations-events --endpoint-url $LOCALSTACK_ENDPOINT --region $AWS_REGION
